...
export const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    let response = await fetch("https://formspree.io/f/xdknavad", {
      method: "POST",
      headers: {
        ...
        <Row className="align-items-center mb-5">
          <Col>
            <div className="personal-details">
              ...
              <p className="iconStyle"><img src={mobileIcon} alt="Mobile" className="icon" /> 7618372810</p>
              <p className="iconStyle"><img src={emailIcon} alt="Email" className="icon" /> mehtapriyanshu1028@gmail.com</p>
            </div>
          </Col>
        </Row>
